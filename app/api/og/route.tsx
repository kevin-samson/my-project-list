...
const ogSvgResponse = fetch(svgURL).then((res) => res.text());

export async function GET(req) {
  try {
    const inter = await interSemiBold;
    const ogSvg = await ogSvgResponse;
    ...
    return new ImageResponse(
      (
        ...
        >
          <div dangerouslySetInnerHTML={{ __html: ogSvg }} />
          <p
            style={{
              position: "absolute",
              bottom: 70,
          ...
          >
            A website showcasing and demonstrating the thought process behind
