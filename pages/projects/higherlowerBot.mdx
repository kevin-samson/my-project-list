...
```
## Conclusion
After running the program for 2 hours stright, the json file contained around 1500 search terms. The bot was able to reach a highscore of 1000 and was able to play without any human intervention.