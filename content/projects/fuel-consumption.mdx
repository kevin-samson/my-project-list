---
title: Predictive Analysis of Vehicle Fuel Consumption
description: Neural network model for predicting vehicle fuel consumption, published as an academic paper.
---
